    ...
    <Link to={to} onClick={onClick} style={{ textDecoration: "none" }}>
      ...
      >
        ...
        >
          {children}
          <motion.span
            variants={{ initial: { x: 0 }, hover: { x: iconOffset } }}
...
function CarouselButton({ direction, onClick }) {
  ...
  return (
    <button
      ...
      onMouseEnter={(event) => {
        event.currentTarget.style.background = "rgba(139, 92, 246, 0.2)";
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <ActionButton to="/about">Get Started</ActionButton>
          <Link
            to="#services"
            onClick={(e) => {
              e.preventDefault();
  ...
  return (
    ...
    >
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto" }}>
        <div className="about-meeraxu-grid">
          {" "}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
